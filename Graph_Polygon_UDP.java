...
public class Graph_Polygon_UDP {

	
	static int udp_packet_count[] = new int[20];
	int tot_p = 0;
	int round = 0;

	
	public Graph_Polygon_UDP()
	{
		udp_packet_count[PacketPrinter_In.a] =PacketPrinter_In.udp[PacketPrinter_In.a]; //tcp패킷의 총 수량
		...
		public JFreeChart getChart()
		{
	        ...
	        for(int i=0;i<round;i++)     
	  	      dataset2.addValue(udp_packet_count[i], "UDP패킷  총개수", Integer.toString(i+1)+"번");
