...
public class Graph_Polygon_IGMP {

	
	static int igmp_packet_count[] = new int[20];
	int tot_p = 0;
	int round = 0;

	
	public Graph_Polygon_IGMP()
	{
		igmp_packet_count[PacketPrinter_In.a] =PacketPrinter_In.igmp[PacketPrinter_In.a]; //tcp패킷의 총 수량
		...
		public JFreeChart getChart()
		{
	        ...
	        for(int i=0;i<round;i++)     
	  	      dataset2.addValue(igmp_packet_count[i], "IGMP패킷  총개수", Integer.toString(i+1)+"번");
