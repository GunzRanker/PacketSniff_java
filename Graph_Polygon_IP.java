...
public class Graph_Polygon_IP {

	
	static int ip_packet_count[] = new int[20];
	int tot_p = 0;
	int round = 0;
	
	
	public Graph_Polygon_IP()
	{
		ip_packet_count[PacketPrinter_In.a] =PacketPrinter_In.ip[PacketPrinter_In.a]; //tcp패킷의 총 수량
		...
		public JFreeChart getChart()
		{
	        ...
	        for(int i=0;i<round;i++)     
	  	      dataset2.addValue(ip_packet_count[i], "IP패킷  총개수", Integer.toString(i+1)+"번");
