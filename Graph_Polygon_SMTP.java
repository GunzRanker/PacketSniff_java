...
public class Graph_Polygon_SMTP {

	
	static int smtp_packet_count[] = new int[20];
	int tot_p = 0;
	int round = 0;
	
	
	public Graph_Polygon_SMTP()
	{
		smtp_packet_count[PacketPrinter_In.a] =PacketPrinter_In.smtp[PacketPrinter_In.a]; //tcp패킷의 총 수량
		...
		public JFreeChart getChart()
		{
	        ...
	        for(int i=0;i<round;i++)     
	  	      dataset2.addValue(smtp_packet_count[i], "SMTP패킷  총개수", Integer.toString(i+1)+"번");
